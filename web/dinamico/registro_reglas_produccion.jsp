                            ...
                            <fieldset>
                                <form action="Usuario" method="POST" class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-9" >
                                            <input type="text" id="form-field-1" name="marca" placeholder="Nombre del Producto" class="col-xs-10 col-sm-5 form-control" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 ">
                                            <input type="text" id="form-field-1" name="unidad" placeholder="Cantidad en una Vuelta" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                            </fieldset>
